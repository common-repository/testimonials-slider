...
<div class="wrap netgo-whois-post-setting">
	...
	<h2><?php _e('Testimonials Setting','');?></h2>
		<table class="form-table">
		<tr valign="top">
				<th scope="row" style="width: 370px;">
					<label for="testimonial_shortcode"><?php _e('Shortcode','');?></label>
				</th>
				<td>
				[Testimonial_Slider]
				</td>
		   ...
		   <tr valign="top">
				...
				<td>
				<input name="testimonial_heading_text" type="text" value="<?php if(get_option('testimonial_heading_text') !=''){ echo get_option('testimonial_heading_text'); }else{ echo '';}?>"/>
				</td>
			</tr>
